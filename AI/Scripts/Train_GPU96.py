...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, GlobalAveragePooling2D, Dense, Dropout, BatchNormalization, Activation, Add
...
def create_deep_model(input_shape, num_classes):
    ...
    shortcut = Conv2D(128, (1, 1), padding='same', kernel_regularizer=l2(0.01))(shortcut)
...
mel_train_dir = 'Train_data/96Mels'
...
with open('model_96.tflite', 'wb') as f:
    f.write(tflite_model)

print("Model TFLite saved as 'model_96x96.tflite'")
